...
from torchutils import visulize_features
...
def ValidateSegmentation(args):
    ...
    print("=" * 60)
    print("Initializing STDDF_MiT model for testing...")
    print("=" * 60)
    ...
    args.vis_dir = './predict/' + args.file_root + '_MiT/'
    ...
    if not os.path.exists(model_file_name):
        ...
        print("Please train the model first using train_mit.py")
        return
...
if __name__ == '__main__':
    ...
    parser.add_argument('--file_root', default="LEVIR", help='Data directory | LEVIR | SYSU | WHU | GZ-CD')
